...
\begin{document}
	\begin{tikzpicture}
	        ...
	        \addplot +[mark=square*, mark size=2pt,  only marks] table [x=e, y=TT] {data/table_e.dat};	   	        

	        \addplot +[mark=*, mark size=1.5pt,  only marks] 
	        %plot [error bars/.cd, y dir = both, y explicit] 
	        table [x=e, y=T] {data/table_e.dat};	        
	        ...
	        % \addplot [samples=100, domain=0:4500, dashdotdotted] {0.001031*x+0.1142};
