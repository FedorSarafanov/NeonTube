...
% \begin{gather*}
% \frac{C R_{0} \Delta \mathcal{E} \rho \left(- R \left(U_{0} - U_\text{г}\right) + R \left(U_{0} - U_\text{з}\right) + R_{0} \left(U_\text{г} - \mathcal{E}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right)}{\left(- R \left(U_{0} - U_\text{г}\right) + R_{0} \left(U_\text{г} - \mathcal{E}\right)\right) \left(R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right)}
% +\\+
% (-) \frac{C \Delta U_\text{г} \rho \left(R + R_{0}\right)}{R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)}
% +\\+
% \frac{C \Delta U_\text{з} \rho \left(R + R_{0}\right)}{R \left(U_{0} - U_\text{г}\right) - R_{0} \left(U_\text{г} - \mathcal{E}\right)}
% +\\+
% \frac{C \Delta R \rho \left(- \left(U_{0} - U_\text{г}\right) \left(R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right) + \left(U_{0} - U_\text{з}\right) \left(R \left(U_{0} - U_\text{г}\right) - R_{0} \left(U_\text{г} - \mathcal{E}\right)\right)\right)}{\left(R \left(U_{0} - U_\text{г}\right) - R_{0} \left(U_\text{г} - \mathcal{E}\right)\right) \left(R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right)}
% +\\+
% \frac{C \Delta R_0 \rho \left(- \left(U_{0} - U_\text{г}\right) \left(R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right) + \left(U_{0} - U_\text{з}\right) \left(R \left(U_{0} - U_\text{г}\right) - R_{0} \left(U_\text{г} - \mathcal{E}\right)\right)\right)}{\left(R \left(U_{0} - U_\text{г}\right) - R_{0} \left(U_\text{г} - \mathcal{E}\right)\right) \left(R \left(U_{0} - U_\text{з}\right) - R_{0} \left(U_\text{з} - \mathcal{E}\right)\right)}
% \end{gather*}
\begin{gather*}
